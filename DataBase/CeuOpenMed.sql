...
CREATE TABLE IF NOT EXISTS `CeuOpenMed`.`Tipo_Entidad` (
  ...
  INDEX `FK_Tipo_Entidad_REF_Idioma1_idx` (`IdIdioma` ASC),
  INDEX `FK_Tipo_Entidad_REF_Doc_Estudiante1_idx` (`IdEstudiante` ASC),
  CONSTRAINT `FK_Tipo_Entidad_REF_Idioma1`
    FOREIGN KEY (`IdIdioma`)
    REFERENCES `CeuOpenMed`.`Idioma` (`IdIdioma`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK_Tipo_Entidad_REF_Doc_Estudiante1`
...
CREATE TABLE IF NOT EXISTS `CeuOpenMed`.`Tipo_Asociacion` (
  ...
  INDEX `FK_Tipo_Asociacion_REF_Entidad1_idx` (`IdEntidad1` ASC),
  INDEX `FK_Tipo_Asociacion_REF_Entidad2_idx` (`IdEntidad2` ASC),
  CONSTRAINT `FK_Tipo_Asociacion_REF_Entidad1`
    FOREIGN KEY (`IdEntidad1`)
    REFERENCES `CeuOpenMed`.`Entidad` (`IdEntidad`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK_Tipo_Asociacion_REF_Entidad2`
...
CREATE TABLE IF NOT EXISTS `CeuOpenMed`.`Detalle_Entidad` (
  ...
  INDEX `FK_DetalleEntidad_REF_Entidad1_idx` (`IdEntidad` ASC),
  INDEX `FK_Detalle_Entidad_REF_Idioma1_idx` (`IdIdioma` ASC),
  CONSTRAINT `FK_DetalleEntidad_REF_Entidad1`
