...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['IdRol'], 'exist', 'skipOnError' => true, 'targetClass' => SegRol::className(), 
                            'targetAttribute' => ['IdRol' => 'IdRol'], 'message' => 'El Rol que seleccionó no existe en la Base de Datos del Sistema.'],
        ];
    }
