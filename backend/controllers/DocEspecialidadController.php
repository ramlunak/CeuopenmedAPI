...
class DocEspecialidadController extends RestController
{
    ...
    public function actionIndex()
    {
        ...
        $response = DocEspecialidad::search($params);
        Yii::$app->api->sendSuccessResponse($response['data'], $response['info']);
    }

    public function actionCreate()
    {
        $model = new DocEspecialidad;
    ...
    {
        if (($model = DocEspecialidad::findOne($id)) !== null) {
            return $model;
        } else {
